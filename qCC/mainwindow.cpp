...
#include "ccAdvancedPropertyBrowserTool.h"
...
void MainWindow::connectActions()
{
    ...
    connect(actionOpenAdvancedPropertyDlg,      SIGNAL(triggered()),	this,		SLOT(doActionOpenAdvancedPropertyEditor()));
...
void MainWindow::doActionOpenAdvancedPropertyEditor()
{

    if (!m_advPropDlg)
{

    m_advPropDlg = new QDialog(this);

       QLayout * layout  = new QGridLayout(m_advPropDlg);

       m_advPropDlg->setLayout(layout);

       PropertyBrowser *propertyBrowser = new PropertyBrowser(m_advPropDlg, this->db());

       layout->addWidget(propertyBrowser);

//        m_advPropDlg = new PropertyBrowser(this, this->db());

    }


    if (m_advPropDlg->isVisible())
        m_advPropDlg->setVisible(false);

    else {
        m_advPropDlg->setVisible(true);
    }
//    this->db()->selectionChanged();
//    this->db()->selectionChanged();
//    connect (this, SIGNAL(selec))
