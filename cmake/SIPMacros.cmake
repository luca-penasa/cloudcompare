...
MACRO(ADD_SIP_PYTHON_MODULE MODULE_NAME MODULE_SIP)
	...
	set_target_properties( ${_logical_name}
		PROPERTIES
		ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/pycc"
		LIBRARY_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/pycc"
		RUNTIME_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/pycc"
	)
